...
const projectData = {
  "AutoArtist": ["browser", ["Página principal","Panel de gestión","Shows","Fans","Editor visual"], ["Home page","Management dashboard","Shows","Fans","Visual editor"], "Experiencia web orientada a la creación visual, con gestión de datos y una interfaz rápida construida sobre un stack moderno.", "A visual-creation web experience with data management and a fast interface built on a modern stack.", "https://autoartist.ifeede.net", ["assets/autoartist/01-home.png","assets/autoartist/03-dashboard.png","assets/autoartist/04-shows.png","assets/autoartist/05-fans.png","assets/autoartist/02-editor.png"], ["browser","browser","browser","browser","browser"], "autoartist.ifeede.net", "production"],
