...
"Laboratorio de Edafología": ["browser", ["Inicio del sistema ROCA","Navegación y módulos","Pedidos pendientes","Carga de pedido"], ["ROCA system home","Navigation and modules","Pending orders","Create order"], "Trabajo realizado junto al equipo de ADINI para la Universidad de Buenos Aires. Participé en el diseño de la experiencia y el desarrollo front-end para digitalizar procesos, pedidos y resultados del laboratorio, con frontend React, backend Kotlin/Spring Boot e infraestructura Docker sobre MySQL.", "A project developed with the ADINI team for the University of Buenos Aires. I worked on experience design and front-end development to digitize laboratory processes, orders and results, with a React frontend, Kotlin/Spring Boot backend and Docker-based infrastructure on MySQL.", null, ["assets/laboratorio-edafologia/01-inicio.png","assets/laboratorio-edafologia/02-menu.png","assets/laboratorio-edafologia/03-pedidos.png","assets/laboratorio-edafologia/04-cargar-pedido.png"], ["browser","browser","browser","browser"], "roca.uba.ar"],
