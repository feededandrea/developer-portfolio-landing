...
const englishCards = {
  "AutoArtist": "A link-in-bio platform for musicians combining visual identity, promotion, fan acquisition and management tools.",
  ...
  "Laboratorio de Edafología": "A full-stack project developed with the ADINI team for the University of Buenos Aires (UBA), where I worked on design and front-end development.",
  ...
  "Home Automation IoT": "A home automation ecosystem integrated with Apple Home, featuring custom-built hardware, circuit boards and firmware."
};

const projectData = {
  "AutoArtist": ["browser", ["Página principal","Panel de gestión","Shows","Fans","Editor visual"], ["Home page","Management dashboard","Shows","Fans","Visual editor"], "Producto integral para artistas independientes, sellos y managers. Combina un editor visual responsive con más de 40 presets, pre-save de Spotify, contenido exclusivo para captar contactos, EPK automático, email y SMS, integración con Meta Ads y TikTok, y analítica propia de visitas, clics, dispositivos y países. El modo multiartista permite administrar un roster y colaborar en equipo desde un único panel.", "An all-in-one product for independent artists, labels and managers. It combines a responsive visual editor with over 40 presets, Spotify pre-saves, gated content for fan acquisition, automatic EPKs, email and SMS, Meta Ads and TikTok integrations, plus first-party analytics for visits, clicks, devices and countries. Multi-artist mode lets teams manage an entire roster from a single dashboard.", "https://autoartist.ifeede.net", ["assets/autoartist/01-home.png","assets/autoartist/03-dashboard.png","assets/autoartist/04-shows.png","assets/autoartist/05-fans.png","assets/autoartist/02-editor.png"], ["browser","browser","browser","browser","browser"], "autoartist.ifeede.net", "production"],
  ...
  "MSN Fun App": ["ipod", ["Contactos"], ["Contacts"], "Cliente nativo para iOS 6 que recupera la identidad visual de MSN y adapta su lista de contactos, estados y conversaciones a una experiencia móvil con presencia en tiempo real.", "A native iOS 6 client that revives MSN's visual identity and adapts its contact list, statuses and conversations into a mobile experience with real-time presence.", "https://github.com/feededandrea/iFeedeBook-MSN-iOS-6.git", ["assets/msn/01-contacts.webp"], ["ipod"]],
  "Laboratorio de Edafología": ["browser", ["Inicio del sistema ROCA","Navegación y módulos","Pedidos pendientes","Carga de pedido"], ["ROCA system home","Navigation and modules","Pending orders","Create order"], "Trabajo realizado junto al equipo de ADINI para la Universidad de Buenos Aires. Participé en el diseño de la experiencia y el desarrollo front-end de un producto full-stack para digitalizar procesos, pedidos y resultados del laboratorio, con frontend React, backend Kotlin/Spring Boot e infraestructura Docker sobre MySQL.", "A project developed with the ADINI team for the University of Buenos Aires. I worked on experience design and front-end development for a full-stack product that digitizes laboratory processes, orders and results, with a React frontend, Kotlin/Spring Boot backend and Docker-based infrastructure on MySQL.", null, ["assets/laboratorio-edafologia/01-inicio.png","assets/laboratorio-edafologia/02-menu.png","assets/laboratorio-edafologia/03-pedidos.png","assets/laboratorio-edafologia/04-cargar-pedido.png"], ["browser","browser","browser","browser"], "roca.uba.ar"],
"Virtual Wallet": ["browser", ["Panel principal"], ["Main dashboard"], "Billetera virtual full-stack con autenticación, saldo disponible, actividad, carga de dinero, pago de servicios, tarjetas y datos de cuenta, con los datos almacenados en una base de datos relacional.", "A full-stack virtual wallet featuring authentication, available balance, activity, deposits, service payments, cards and account details, with data stored in a relational database.", "https://github.com/feededandrea/digital-money", ["assets/virtual-wallet/01-dashboard.png"], ["browser"], "digital-money.local"],
  ...
  "Home Automation IoT": ["browser", ["Panel Homebridge"], ["Homebridge dashboard"], "Ecosistema de automatización doméstica desarrollado desde 2017. Una Raspberry Pi con Debian y Homebridge conecta Apple Home y HomeKit con módulos ESP8266 distribuidos por la casa, permitiendo controlar luces, interruptores y tomas desde iPhone, Mac y Apple Watch. Diseñé y soldé placas propias para switches y outlets, y desarrollé firmware personalizado para integrar dispositivos Sonoff al sistema.", "A home automation ecosystem developed since 2017. A Raspberry Pi running Debian and Homebridge connects Apple Home and HomeKit to ESP8266 modules throughout the house, allowing lights, switches and outlets to be controlled from iPhone, Mac and Apple Watch. I designed and soldered custom circuit boards for switches and outlets, and developed custom firmware to integrate Sonoff devices into the system.", "https://github.com/feededandrea/esp-homekit-demo", ["assets/iot/01-homebridge-dashboard.png"], ["browser"], "homebridge.local"]
};
...
function openProject(project, index, preserveSlide = false) {
  ...
  const techLine = project.dataset.tech || project.querySelector(".project-meta small").textContent;
  ui.tech.replaceChildren(...techLine.split(" · ").map(text => Object.assign(document.createElement("span"), {textContent:text})));
